...
function App() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-black via-gray-900 to-black p-6">
      <div className="max-w-2xl mx-auto bg-gray-900 rounded-xl shadow-2xl p-6 text-gray-100">
        <div className="flex items-center gap-3 mb-6">
          <Calculator className="w-8 h-8 text-blue-500" />
          <h1 className="text-2xl font-bold">Calculadora de Dutching</h1>
        </div>
        ...
        <div className="grid grid-cols-2 gap-6 mb-6">
          <div>
            ...
            <input
              ...
              className="w-full px-3 py-2 text-lg bg-black border border-gray-800 rounded-md focus:ring-2 focus:ring-blue-500 focus:border-blue-500 text-gray-100"
            />
          </div>
          <div className="space-y-2">
            <div className="flex justify-between items-center">
              <span className="text-sm font-medium">Lucro:</span>
              <span className={`text-lg font-semibold ${profit < 0 ? 'text-red-500' : 'text-green-500'}`}>
                R$ {profit.toFixed(2)}
              </span>
            </div>
            <div className="flex justify-between items-center">
              <span className="text-sm font-medium">Retorno:</span>
              <span className="text-lg font-semibold text-blue-500">R$ {totalReturn.toFixed(2)}</span>
            </div>
          </div>
        </div>

        <div className="mb-6">
          <div className="grid grid-cols-12 gap-2 mb-2 px-3 py-2 bg-black rounded-t-lg">
            <div className="col-span-1 text-sm font-medium"></div>
            <div className="col-span-2 text-sm font-medium">Odds</div>
            <div className="col-span-4 text-sm font-medium">Investimento</div>
            <div className="col-span-4 text-sm font-medium">Retorno</div>
            <div className="col-span-1"></div>
          </div>

          {bets.map((bet, index) => (
            <div key={index} className="grid grid-cols-12 gap-2 px-3 py-2 items-center border-b border-gray-800">
              <div className="col-span-1 text-sm font-medium">{index + 1}º</div>
              <div className="col-span-2">
                <input
                  type="text"
                  value={bet.odds || ''}
                  onChange={(e) => updateBet(index, e.target.value)}
                  className="w-full px-2 py-1 bg-black border border-gray-800 rounded-md focus:ring-2 focus:ring-blue-500 focus:border-blue-500 text-gray-100"
                  placeholder="0.00"
                />
              </div>
              <div className="col-span-4 flex items-center gap-2">
                ...
                <button
                  ...
                  className="p-1 text-gray-500 hover:text-blue-400 hover:bg-black rounded transition-colors"
                >
              ...
              <div className="col-span-1">
                {bets.length > 2 && (
                  <button
                    ...
                    className="p-1 text-red-500 hover:text-red-400 hover:bg-black rounded transition-colors"
                  >
        ...
        <div className="flex gap-4">
          <button
            onClick={addNewBet}
            className="px-4 py-2 text-sm font-medium text-blue-400 border border-blue-500 rounded-md hover:bg-black transition-colors flex items-center gap-2"
          >
          ...
          <button
            ...
            className="px-4 py-2 text-sm font-medium text-red-400 border border-red-500 rounded-md hover:bg-black transition-colors flex items-center gap-2"
          >
